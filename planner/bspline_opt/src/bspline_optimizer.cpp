...
namespace ego_planner
{
  ...
  std::vector<std::vector<Eigen::Vector3d>> BsplineOptimizer::initControlPoints(Eigen::MatrixXd &init_points, bool flag_first_init /*= true*/)
  {
    ...
    std::cout << "a star search end" << std::endl;
    /*** calculate bounds ***/
    ...
    std::cout << "calculate bounds end" << std::endl;
    // cout << "+++++++++" << endl;
    ...
    std::cout << "Adjust segment length end" << std::endl;
    ...
    for (size_t i = 0; i < segment_ids.size(); i++)
    {
      ...
      std::cout << "Assign data to each segment step 2 end" << std::endl;
    ...
    std::cout << "cps_.base_point size =" << cps_.base_point.size() << std::endl;
    std::cout << "cps_.direction size =" << cps_.direction.size() << std::endl;
    std::cout <<"segment_ids =" << segment_ids.size() << std::endl;
